# -*- coding: utf-8 -*-
"""
Created on Wed Apr 18 13:13:34 2018
...
#the data with questions and intents
cd = pd.read_csv('chat_train.csv')

#the data with intents and answers
...
#udf which creates a countvectorizer on stemmed words
class StemmedCountVectorizer(CountVectorizer):
    def build_analyzer(self):
        analyzer = super(StemmedCountVectorizer, self).build_analyzer()
        return lambda doc: ([stemmer.stem(w) for w in analyzer(doc)])

#ngram range of 3 means single gram, bigram and trigram words
stemmed_count_vect = StemmedCountVectorizer(ngram_range=(1,3))

#pipeline of two transformations
pl = Pipeline([
